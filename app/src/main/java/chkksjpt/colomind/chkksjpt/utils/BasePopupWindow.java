...
public class BasePopupWindow extends PopupWindow {
    ...
    public void setOutsideTouchable(boolean touchable) {
        ...
        if (touchable) {
            if (mBackgroundDrawable == null) {
                /*mBackgroundDrawable = new ColorDrawable(getContext().getResources().getColor(R.color.grey_600));*/
                mBackgroundDrawable = new ColorDrawable(0x757575);
     ...
     */
    private void initBasePopupWindow(int width, int height) {
