...
//	public final static String HOST="192.168.1.155";
    ...
    //草海地图
    public final static String CHDXTURL = "http://" + HOST + ":" + MAPPORT + "/arcgis/rest/services/CHDXT/CHDXT/MapServer";
    public final static String CHGHURL = "http://" + HOST + ":" + MAPPORT + "/arcgis/rest/services/CAOHAIGUIHUA/CAOHAIGUIHUA/MapServer";
    public final static String CHLIUYUURL = "http://" + HOST + ":" + MAPPORT + "/arcgis/rest/services/CaoHaiLiuYu/CaoHaiLiuYu/MapServer";

    //草海要素图层
    public static final String FEATURE_0_URL = "http://" + HOST + ":" + MAPPORT + "/arcgis/rest/services/CAOHAIGUIHUA/CAOHAIGUIHUA/FeatureServer/0";
    public static final String FEATURE_1_URL = "http://" + HOST + ":" + MAPPORT + "/arcgis/rest/services/CAOHAIGUIHUA/CAOHAIGUIHUA/FeatureServer/1";
    public static final String FEATURE_ROAD_POLYLINE_URL = "http://" + HOST + ":" + MAPPORT + "/arcgis/rest/services/CAOHAIGUIHUA/CAOHAIGUIHUA/FeatureServer/2";
    public static final String FEATURE_3_URL = "http://" + HOST + ":" + MAPPORT + "/arcgis/rest/services/CAOHAIGUIHUA/CAOHAIGUIHUA/FeatureServer/3";
    public static final String FEATURE_4_URL = "http://" + HOST + ":" + MAPPORT + "/arcgis/rest/services/CAOHAIGUIHUA/CAOHAIGUIHUA/FeatureServer/4";
    public static final String FEATURE_5_URL = "http://" + HOST + ":" + MAPPORT + "/arcgis/rest/services/CAOHAIGUIHUA/CAOHAIGUIHUA/FeatureServer/5";
    public static final String FEATURE_6_URL = "http://" + HOST + ":" + MAPPORT + "/arcgis/rest/services/CAOHAIGUIHUA/CAOHAIGUIHUA/FeatureServer/6";
    public static final String FEATURE_7_URL = "http://" + HOST + ":" + MAPPORT + "/arcgis/rest/services/CAOHAIGUIHUA/CAOHAIGUIHUA/FeatureServer/7";
